...
# 10:shield_a  11:shield_b  12:chat_id_a  13:chat_id_b  14:invite_msg_id
# 15:invited_at  16:last_action_at  17:finished_at
    ...
    while True:
        try:
            ...
            for b in expired_invites:
                ...
                cid_a = b[12]; cid_b = b[13]; imid = b[14]
                cancel_battle(bid, a_id, b_id)
                try:
                    if imid: bot.delete_message(cid_b, imid)
                except: pass
                try:
                    bot.send_message(cid_a,
                        f"⏰ Приглашение на битву от *{a_name}* истекло.",
                        parse_mode='Markdown')
                except: pass
                try:
                    if cid_b and cid_b != cid_a:
                        bot.send_message(cid_b,
                            f"⏰ Приглашение на битву от *{a_name}* истекло.",
                            parse_mode='Markdown')
                except: pass
