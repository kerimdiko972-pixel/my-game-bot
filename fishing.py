...
FISH_TABLE = [
    # ── Обычные 50% ─────────────────────────────────────────
    (RARITY_COMMON, '🐟', 'Анчоус',       2,   40, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Карась',       2,   60, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Плотва',       3,   70, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Краснопёрка',  3,   80, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Окунь',        3,  100, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Бычок',        3,  110, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Салака',       2,   50, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Уклейка',      3,   60, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Пескарь',      3,   70, 10, 50, 3.0),
    (RARITY_COMMON, '🐟', 'Молодой карп', 4,  120, 10, 50, 3.0),
    # ── Необычные 25% ───────────────────────────────────────
    (RARITY_UNCOMMON, '🐠', 'Лещ',           5,  180, 50, 100, 2.5),
    (RARITY_UNCOMMON, '🐠', 'Голавль',       5,  200, 50, 100, 2.5),
    (RARITY_UNCOMMON, '🐠', 'Язь',           6,  220, 50, 100, 2.5),
    (RARITY_UNCOMMON, '🐠', 'Форель',        6,  260, 50, 100, 2.5),
    (RARITY_UNCOMMON, '🐠', 'Щука',          7,  320, 50, 100, 2.5),
    (RARITY_UNCOMMON, '🐠', 'Сазан',         7,  350, 50, 100, 2.5),
    (RARITY_UNCOMMON, '🐠', 'Камбала',       6,  240, 50, 100, 2.5),
    (RARITY_UNCOMMON, '🐠', 'Морской окунь', 6,  280, 50, 100, 2.5),
    # ── Редкие 15% ──────────────────────────────────────────
    (RARITY_RARE, '🦈', 'Судак',      8,   500, 100, 250, 2.0),
    (RARITY_RARE, '🦈', 'Амур',       9,   600, 100, 250, 2.0),
    (RARITY_RARE, '🦈', 'Осётр',     10,   750, 100, 250, 2.0),
    (RARITY_RARE, '🦈', 'Сом',       11,   900, 100, 250, 2.0),
    (RARITY_RARE, '🦈', 'Рыба-меч',  12,  1200, 100, 250, 2.0),
    (RARITY_RARE, '🦈', 'Тунец',     10,   800, 100, 250, 2.0),
    # ── Эпические 7% ────────────────────────────────────────
    (RARITY_EPIC, '🐋', 'Гигантская щука', 14, 2500, 250, 500, 1.5),
    (RARITY_EPIC, '🐋', 'Золотой карп',    13, 2200, 250, 500, 1.5),
    (RARITY_EPIC, '🐋', 'Титан-сом',       15, 3200, 250, 500, 1.5),
    (RARITY_EPIC, '🐋', 'Лунная форель',   12, 2800, 250, 500, 1.5),
    # ── Легендарные 3% ──────────────────────────────────────
    (RARITY_LEGENDARY, '🐉', 'Рыба-Дракон',  18, 7000, 500, 1000, 1.0),
    (RARITY_LEGENDARY, '🐲', 'Древний осётр',20, 9000, 500, 1000, 1.0),
]
...
LINE_LEVELS = {
    1: {'max_tension': 10, 'price': 0},
    2: {'max_tension': 14, 'price': 4000},
    3: {'max_tension': 18, 'price': 20000},
    4: {'max_tension': 24, 'price': 100000},
    5: {'max_tension': 32, 'price': 400000},
}
HOOK_LEVELS = {
