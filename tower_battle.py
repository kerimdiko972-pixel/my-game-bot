...
def register_tower_battle(bot):
    ...
    def cb_tb_defend(call):
        ...
        # Тик КД навыков
        try:
            from tower_skills import tick_skill_buffs
            tick_skill_buffs(char, state, user_id)
        except: pass
    ...
    def cb_tb_next_floor(call):
        ...
        # Сброс КД навыков при смене этажа
        try:
            from tower_skills import reset_skill_cds
            reset_skill_cds(state)
        except: pass
