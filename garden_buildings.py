...
RECIPES = {
    ...
    'salad_fruit':  {'building': 'kitchen', 'category': 'Салаты',
                     'name': 'Фруктовый салат', 'emoji': '🥗',
                     'ingredients': {'any_fruit': 4},
                     'time_min': 25, 'price': 600, 'exp': 15},
    ...
    'compote_mix':  {'building': 'barrel', 'category': 'Компоты',
                     ...
                     'ingredients': {'🍎': 2, '🍓': 2, '🍒': 1, '🍉': 1},
                     'time_min': 75, 'price': 4050, 'exp': 40},
    'juice_watermelon': {'building': 'barrel', 'category': 'Соки',
                         'name': 'Арбузный сок',  'emoji': '🫙🍉',
                         'ingredients': {'🍉': 3},
                         'time_min': 35, 'price': 3000, 'exp': 40},
    # ── Варочный котёл ───────────────────────────────────────
    ...
    'jam_melon':        {'building': 'cauldron', 'category': 'Варенья',
                         'name': 'Дыневый джем',  'emoji': '🍯🍈',
                         'ingredients': {'🍈': 3},
                         'time_min': 50, 'price': 2750, 'exp': 35},
